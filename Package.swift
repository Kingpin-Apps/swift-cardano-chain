...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Kingpin-Apps/swift-cardano-utils.git", from: "0.4.5"),
        ...
        .package(url: "https://github.com/Kingpin-Apps/swift-ogmios.git", from: "0.2.0"),
        .package(url: "https://github.com/Kingpin-Apps/swift-cardano-network.git", from: "1.0.9"),
        .package(url: "https://github.com/Kingpin-Apps/swift-cardano-uplc.git", from: "0.1.5"),
