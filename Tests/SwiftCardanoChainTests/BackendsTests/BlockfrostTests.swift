...
struct BlockfrostChainContextTests {
    ...
    func testInit(_ networks: (SwiftCardanoChain.Network, SwiftCardanoCore.Network)) async throws {
        let chainContext = try await BlockFrostChainContext<Never>(
            ...
            client: Client(
                serverURL: URL(
                    string: "https://cardano-\(networks.0.description).blockfrost.io/api/v0"
                )!,
    ...
    func testGenesisParameters() async throws {
        ...
        #expect(genesisParameters.networkId == Network.preview.description)
        #expect(genesisParameters.networkMagic == 764824073)
        ...
        #expect(genesisParameters.systemStart == Date(timeIntervalSince1970: 1506203091))
    ...
    func testStakeAddressInfo() async throws {
        ...
        #expect(
            stakeAddressInfo[0].stakeRegistrationDeposit == nil
        )
        #expect(
