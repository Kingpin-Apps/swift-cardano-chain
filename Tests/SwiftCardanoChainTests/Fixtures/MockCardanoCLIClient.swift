...
func createCardaonCLIMockCommandRunner(
    ...
    given(commandRunner)
        ...
        .run(
            arguments: .value([config.cardano!.cli!.string] + CLICommands.queryGovState),
            environment: .any,
            workingDirectory: .any
        )
        .willReturn(
            AsyncThrowingStream<CommandEvent, any Error> { continuation in
                continuation.yield(
                    .standardOutput([UInt8](CLIResponse.govState.utf8))
                )
                continuation.finish()
            }
        )
...
struct CLICommands {
    ...
    static let addressBuild = [
        "conway", "address", "build", "--payment-verification-key-file", "test.vkey",
        "--testnet-magic", "2",
    ]

    static let stakePoolId = [
        "conway", "stake-pool", "id", "--cold-verification-key-file", "cold.vkey",
    ]

    static let governanceDRepId = [
        "conway", "governance", "drep", "id", "--drep-verification-key-file", "drep.vkey",
    ]

    static let utxos = [
        "conway", "query", "utxo", "--address",
        "addr_test1qp4kux2v7xcg9urqssdffff5p0axz9e3hcc43zz7pcuyle0e20hkwsu2ndpd9dh9anm4jn76ljdz0evj22stzrw9egxqmza5y3",
        "--out-file", "/dev/stdout", "--testnet-magic", "2",
    ]

    static let utxoInput = [
        "conway", "query", "utxo", "--tx-in",
        "39a7a284c2a0948189dc45dec670211cd4d72f7b66c5726c08d9b3df11e44d58#0", "--output-json",
        "--out-file", "/dev/stdout", "--testnet-magic", "2",
    ]

    static let stakeAddressInfo = [
        "conway", "query", "stake-address-info", "--address",
        "stake_test1upyz3gk6mw5he20apnwfn96cn9rscgvmmsxc9r86dh0k66gswf59n", "--out-file",
        "/dev/stdout", "--testnet-magic", "2",
    ]

    static let stakePools = ["conway", "query", "stake-pools", "--testnet-magic", "2"]

    static let poolState = [
        "conway", "query", "pool-state", "--stake-pool-id",
        "pool1m5947rydk4n0ywe6ctlav0ztt632lcwjef7fsy93sflz7ctcx6z", "--testnet-magic", "2",
    ]

    static let stakeSnapshot = [
        "conway", "query", "stake-snapshot", "--stake-pool-id",
        "pool1m5947rydk4n0ywe6ctlav0ztt632lcwjef7fsy93sflz7ctcx6z", "--testnet-magic", "2",
    ]
    ...
    static let drepStakeDistribution = [
        "conway", "query", "drep-stake-distribution", "--all-dreps", "--output-json",
        "--testnet-magic", "2",
    ]

    static let drepKeyHash = [
        "conway", "query", "drep-state", "--drep-key-hash",
        "b02f7b335aebf284bbdc20bdc3b59e4e183ae2cfc47ad2d8bc19a241", "--include-stake",
        "--output-json", "--testnet-magic", "2",
    ]

    static let drepScriptHash = [
        "conway", "query", "drep-state", "--drep-script-hash",
        "5a5ba42f130741d62384c390cfc84d9ceecc8a4bef38059ff18ba74b", "--include-stake",
        "--output-json", "--testnet-magic", "2",
    ]
    ...
    static var utxos: String {
        let dictionary = [
            "39a7a284c2a0948189dc45dec670211cd4d72f7b66c5726c08d9b3df11e44d58#0": [
                    ...
                    "fields": [
                        ...
                        [
                            "list": [
                                [
                                    "bytes":
                                        "4dd98a2ef34bc7ac3858bbcfdf94aaa116bb28ca7e01756140ba4d19"
                                ]
                            ]
                        ],
                        ["int": 10_000_000_000],
                ...
                "inlineDatumhash":
                    "c56003cba9cfcf2f73cf6a5f4d6354d03c281bcd2bbd7a873d7475faa10a7123",
                "referenceScript": nil,
                "value": [
                    "2e11e7313e00ccd086cfc4f1c3ebed4962d31b481b6a153c23601c0f": [
                    ...
                    "8e51398904a5d3fc129fbf4f1589701de23c7824d5c90fdb9490e15a": [
                        "434841524c4933": 1_367_726_755
                    ],
                    "d8d46a3e430fab5dc8c5a0a7fc82abbf4339a89034a8c804bb7e6012": [
                        "636861726c69335f6164615f6c71": 9_223_372_035_870_126_880
                    ],
                    "lovelace": 708_864_940,
                ],
            ]
        ]
    ...
    static let govState = """
        {
          "proposals": [
            {
              "actionId": {
                "txId": "2dd15e0ef6e6a17841cb9541c27724072ce4d4b79b91e58432fbaa32d9572531",
                "govActionIx": 1
              },
              "proposedIn": 100,
              "expiresAfter": 120,
    ...
    public func runCommand(_ cmd: [String]) throws -> String {
        ...
        if cmd.contains(["query", "tip"]) {
            ...
            dictionary = [
                ...
                "voteDelegation":
                    "keyHash-9be9b6efd0649b354b682f6875174d0ac9056cea40a8da6fd3935d82",
            ]
