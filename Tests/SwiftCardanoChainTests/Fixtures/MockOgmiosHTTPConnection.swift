...
final class MockOgmiosHTTPConnection: HTTPConnectable, @unchecked Sendable {
    ...
    func sendRequest(json: String) async throws -> Data {
        ...
        case "queryLedgerState/governanceProposals":
            return OgmiosMockData.governanceProposals
...
enum OgmiosMockData {
    ...
    static let governanceProposals = """
        {
            "jsonrpc": "2.0",
            ...
            "result": [
                {
                    "proposal": {
                        "transaction": {
                            "id": "2dd15e0ef6e6a17841cb9541c27724072ce4d4b79b91e58432fbaa32d9572531"
                        },
                        "index": 1
                    },
                    "deposit": {
                    ...
                    "returnAccount": "stake_test1upyz3gk6mw5he20apnwfn96cn9rscgvmmsxc9r86dh0k66gswf59n",
                    "metadata": {
                        "url": "https://example.com",
                        "hash": "34f05fe67c8f4172ac5e955c20c8204d37a3f5b2561038d199f4f626a32db6cf"
                    },
                    "since": {
                        "epoch": 100
                    },
...
func createMockOgmiosChainContext(network: SwiftCardanoCore.Network = .preview) async throws
    -> OgmiosChainContext
{
