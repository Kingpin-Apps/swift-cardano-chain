...
public class OgmiosChainContext: ChainContext {
    ...
    public lazy var protocolParameters: () async throws -> SwiftCardanoCore.ProtocolParameters = { [weak self] in
        guard let self = self else {
            throw CardanoChainError.operationError("Self is nil")
        }
    ...
    /// }
    /// ```
    public func stakeAddressInfo(address: SwiftCardanoCore.Address) async throws -> [StakeAddressInfo] {
        ...
        case .scriptHash(let hash):
            credentialHex = hash.payload.toHex
        case .pointerAddress:
            throw CardanoChainError.invalidArgument("Pointer addresses not supported for stake info")
        }
    ...
    private func convertScript(_ script: SwiftOgmios.Script) throws -> ScriptType {
        ...
        case .plutus(let plutusScript):
            ...
            default:
                throw CardanoChainError.valueError("Unknown Plutus version: \(plutusScript.language)")
            }
        }
    }
    ...
    private func convertProtocolParameters(
        ...
        if let thresholds = params.delegateRepresentativeVotingThresholds {
            ...
            dRepVotingThresholds = DRepVotingThresholds(
                ...
                ppNetworkGroup: 0, ppTechnicalGroup: 0, treasuryWithdrawal: 0, updateToConstitution: 0
            )
        }
        ...
        return SwiftCardanoCore.ProtocolParameters(
            collateralPercentage: params.collateralPercentage != nil ? Int(params.collateralPercentage!) : 150,
            committeeMaxTermLength: params.constitutionalCommitteeMaxTermLength != nil ? Int(params.constitutionalCommitteeMaxTermLength!) : 0,
            committeeMinSize: params.constitutionalCommitteeMinSize != nil ? Int(params.constitutionalCommitteeMinSize!) : 0,
            costModels: costModels,
            dRepActivity: params.delegateRepresentativeMaxIdleTime != nil ? Int(params.delegateRepresentativeMaxIdleTime!) : 0,
            dRepDeposit: params.delegateRepresentativeDeposit != nil ? Int(params.delegateRepresentativeDeposit!.ada.lovelace) : 0,
            dRepVotingThresholds: dRepVotingThresholds,
            executionUnitPrices: executionPrices,
            govActionDeposit: params.governanceActionDeposit != nil ? Int(params.governanceActionDeposit!.ada.lovelace) : 0,
            govActionLifetime: params.governanceActionLifetime != nil ? Int(params.governanceActionLifetime!) : 0,
            ...
            maxCollateralInputs: params.maxCollateralInputs != nil ? Int(params.maxCollateralInputs!) : 3,
            maxTxExecutionUnits: maxTxExUnits,
            maxTxSize: params.maxTransactionSize != nil ? Int(params.maxTransactionSize!.bytes) : 16384,
